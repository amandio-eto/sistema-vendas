...
<div class="row g-3 m-3">
    {{-- MonthlyChart --}}
    <div class="col-md">
        <div class="card shadow-sm" style="border-radius:12px; padding:15px;">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    Highcharts.chart('pieContainerLiters',{
        ...
        tooltip:{pointFormatter:function(){return '<b>'+this.name+'</b>: '+this.y.toLocaleString('en-US',{minimumFractionDigits:2})+' L';}},
        plotOptions:{pie:{allowPointSelect:true,cursor:'pointer',dataLabels:{enabled:true,formatter:function(){return '<b>'+this.point.name+'</b>: '+this.y.toLocaleString('en-US',{minimumFractionDigits:2})+' L';}},showInLegend:true,animation:{duration:2000,easing:'easeOutBounce'}}},
