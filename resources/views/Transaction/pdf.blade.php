...
">
    ...
    <!-- FOOTER -->
    <footer>
      This document is officially generated by the electronic system of Esperança Timor Oan.Lda to ensure authenticity for all clients. | Thanks .. {{ \Carbon\Carbon::now()->format('Y') }}
    </footer>
