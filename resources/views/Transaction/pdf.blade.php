...
">
   ...
   <table style="width:100%; border-collapse:collapse; border:1px dotted #000; margin-top:10px;">
    ...
    <!-- FOOTER -->
    <footer>
      This document is officially generated by the electronic system of Esperança Timor Oan.Lda to ensure authenticity for all clients. %cop | Thanks .. {{ \Carbon\Carbon::now()->format('Y') }}
    </footer>
