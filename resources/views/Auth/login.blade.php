...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Portal Eletronico || PAC-HERA</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    <div class="wd-50 bg-white p-2 rounded-circle shadow-lg position-absolute translate-middle top-0 start-50">
                        <img src="{{ asset('tank.jpg') }}" alt="" class="img-fluid" height="100" width="100">
                    </div>
                    <div class="card-body p-sm-5">
                        <h2 class=" text-center nfs-20 fw-bolder mb-4">Login</h2>
                        ...
                        <form action="{{ route('dologin') }}" class="w-100 mt-4 pt-2" method="POST">
                            ...
                            <p class="text-center mt-2">Develop By Esperaca Group Team</p>
                        </form>
